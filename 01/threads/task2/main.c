...
int main(int argc, char *argv[])
{
    ...
    rc = pthread_create(
        &main_writer_thread, // thread identifier
        NULL,                // thread attributes
        (void *)main_writer, // thread function
    ...
    // Wait for the writer
    pthread_join(main_writer_thread, NULL);
